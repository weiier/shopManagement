          ...
          <div class="sidebar-nav">
            <div class="nav-canvas">
              ...
              <ul id = "leftMenu" class="nav nav-pills nav-stacked main-menu">
                <li >
                  <a href="us_home.jsp"><i class="glyphicon glyphicon-home"></i><span>  在线选铺</span></a>                
                </li>
				<li class="active">
		  ...
		  <div class="row">
              <div>
                  <ul id="myTab" class="nav nav-tabs">
                      ...
                      <li ><a href="#ios" data-toggle="tab">咨询记录</a></li>
                      <li><a href="#addMessage" id="btn-add" data-toggle="tab" ><i class="glyphicon glyphicon-plus">留言咨询</i></a></li>
...
<div class="modal fade" id="leaseModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<a  id="editL" href="#" class="btn btn-primary" data-dismiss="modal">修改</a>
				</div>
			</div>
		</div>
	</div>
    ...
    <script src="js/us_message.js"></script>
