...
function getApplyNewList() {
	var  url = "http://"+publicElement.ip+":"+publicElement.port+"/vmapAPI/apply!adminSelectNew?jsoncallback=?";
    $.getJSON(
        url,
        function( result ) {
            if ( !result.success ) {
...
function getApplyOldList() {
    var  url = "http://"+publicElement.ip+":"+publicElement.port+"/vmapAPI/apply!adminSelectOld?jsoncallback=?";
    $.getJSON(
        url,
        function( result ) {
            if ( !result.success ) {
...
function getLeaseList() {
	...
	var  newurl = "http://"+publicElement.ip+":"+publicElement.port+"/vmapAPI/lease!selectNew?jsoncallback=?";
    $.getJSON(
        newurl,
        function( result ) {
            if ( !result.success ) {
...
//get lists for leases_old
function getCheckList() {
    var  oldurl = "http://"+publicElement.ip+":"+publicElement.port+"/vmapAPI/lease!selectOld?jsoncallback=?";
    $.getJSON(
        oldurl,
        function( result ) {
            if ( !result.success ) {
...
$("#auditClick").on("click",function(){
 ...
 //download excel
$(".downloadMessageExcel").click(function(event){   
    var url = "http://"+publicElement.ip+":"+publicElement.port+"/vmapAPI/download!getConsultData?jsoncallback=?";
    $.getJSON(
        url,function(data){
            if( !data.success ){
                alert(data.success);
            ...
            location.href = "http://"+publicElement.ip+":"+publicElement.port+"/vmapAPI/consultData.xls";
        }
    );
    event.stopPropagation();
});

$(".downloadLeaseExcel").click(function(event){   
    var url = "http://"+publicElement.ip+":"+publicElement.port+"/vmapAPI/download!getLeaseData?jsoncallback=?";
    $.getJSON(
        url,function(data){
            if( !data.success ){
                alert(data.success);
            ...
            location.href = "http://"+publicElement.ip+":"+publicElement.port+"/vmapAPI/leaseData.xls";
        }
    );
    event.stopPropagation();
});
