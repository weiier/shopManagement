        ...
        <div class="navbar-inner">
            ...
            <div class="btn-group pull-right theme-container animated tada">
                <button class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                    ...
                    <span class="hidden-sm hidden-xs" id="login_proxy" uid="admin" state="0"> ${sessionScope.admin.username}</span>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel">分配专员</h4>
            </div>
            <div class="modal-body">			
				<div class="panel panel-success">
				  <div class="panel-heading">已选择的商铺编号</div>
				  <div class="panel-body">112</div>
				</div>
			
				<div class="panel panel-info">
				  <div class="panel-heading">可选择的专员</div>
